...
HRDrawModule.HR2DView.prototype.onMouseWheel= function () {
	if(this.hrView)
	{
		var view = this.hrView;
		var canvasPosition = view.getMousePos(window.event);
		...
		var wheelSens = window.event.wheelDelta;
		var zoomStep = 1;
		if(wheelSens > 0)
			zoomStep = 1.1;
		else
...
HRDrawModule.HR2DView.prototype.onClickDown = function () {
...
HRDrawModule.HR2DView.prototype.onClickUp = function () {
...
HRDrawModule.HR2DView.prototype.onMouseMove = function () {
